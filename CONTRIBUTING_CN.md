# 为 ESP 芯片勘误表贡献力量 ([English](CONTRIBUTING.md))

本项目使用 reStructuredText (RST) 格式编写勘误表文档，并通过 Sphinx 工具构建为 HTML 和 PDF 格式。
...
5. 签署 [贡献者许可协议 (CLA)](https://cla-assistant.io/espressif/esp-chip-errata)。CLA 助手将在 PR 评论区引导签署流程。
...
* 审核通过并入内部仓库默认分支后，您的修改将：
  ...
  * 发布至 [官方文档网站](https://docs.espressif.com/projects/esp-chip-errata/zh_CN/latest/esp32/index.html)。
  * 同步回此 GitHub 公共仓库。
